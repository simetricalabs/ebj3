...
.slideInfoZone, .carouselContainer {width:<?php echo $s5_body_width / 2;  ?>% !important;}
#s5_register, #s5_login, .s5_pricetable_column, .button, a.readon, div.catItemReadMore, .userItemReadMore, div.catItemCommentsLink, .userItemCommentsLink, a.readmore-link, a.comments-link, div.itemCommentsForm form input#submitCommentButton, .MultiBoxNext, .MultiBoxNumber, .MultiBoxDescription, .MultiBoxControls, li.pagenav-next, li.pagenav-prev, .pager a, .btn-primary {font-family: <?php echo $s5_fonts_highlight;?> !important;} 

.jdGallery .slideInfoZone h2 {font-family: <?php echo $s5_fonts_highlight_iacf;?> !important;} 

#s5_header_menuright, .module_round_box-lightgray .s5_mod_h3_outer h3, input.button, #s5box_login_inner .button, #s5box_register_inner .button, .jdGallery .slideInfoZone h2, .jdGallery .carousel .carouselInner .active, .module_round_box-highlight1, .pagination ul > li > span, .btn {background:#<?php echo $s5_highlight_one; ?>;}
#s5_accordion_menu h3, .s5_responsive_mobile_drop_down_inner button, .s5_responsive_mobile_drop_down_inner .button, .thumbnail.active, .s5_is_slide, .btn-primary{background:#<?php echo $s5_highlight_one; ?> !important;}
#s5_register, #s5_button_frame ul li.s5_ts_active a, .s5_highlightcolor {color:#<?php echo $s5_highlight_one; ?> !important;}
...
#s5_header_area1 {
	...
	background: linear-gradient(to right, #252525 0%,#252525 50%,#<?php echo $s5_highlight_one; ?> 50%,#<?php echo $s5_highlight_one; ?> 100%); /* W3C */
...
#s5_nav li.active a, .module_round_box .s5_h3_first, .module_round_box-darkgray2 .s5_mod_h3_outer h3 .s5_h3_first, .module_round_box-darkgray .s5_mod_h3_outer h3 .s5_h3_first, .s5_pricetable_column.recommended .button, a {color:#<?php echo $s5_highlight_two; ?>;}
.module_round_box-blue input.button, .s5_pricetable_column.recommended, .jdGallery .slideInfoZone p, .button, li.pagenav-prev, li.pagenav-next, .S5_submenu_item:hover{ background:#<?php echo $s5_highlight_two; ?>;}
div.thumbnail, .jdGallery a.left, .jdGallery a.right, .module_round_box-highlight2, .pager a, .pagination ul > li > a, p.readmore a.btn{ background-color:#<?php echo $s5_highlight_two; ?> !important;}
	
.s5_pricetable_column.recommended .s5_title, .s5_pricetable_column.recommended .s5_horizontalrule { background:#<?php echo change_Color($s5_highlight_two,'+15'); ?> !important;}
	
#s5_top_row3_area2 { background:url(<?php echo $s5_toprow3area2; ?>) no-repeat center top;}
body  {	background:#252525 url(<?php echo $s5_background; ?>) repeat-x bottom;}
