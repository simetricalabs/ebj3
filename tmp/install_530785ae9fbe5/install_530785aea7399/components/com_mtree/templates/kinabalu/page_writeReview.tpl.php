...
<div id="listing">
	...
	<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="mtForm" id="mtForm" class="form-horizontal row-fluid">
		<?php if ( !($this->my->id > 0) ) { ?>
		...
		<?php if( $this->config->get('use_captcha_review') ) { JHtml::_('behavior.framework'); ?>
		<div class="control-group">
