...
class mUpgrade_3_0_0 extends mUpgrade {
	...
	function upgrade() {
		...
		$database->setQuery('UPDATE `#__mt_config` SET `default` = \'/media/com_mtree/images/cats/s/\', `value` = \'/media/com_mtree/images/cats/s/\' WHERE varname = \'relative_path_to_cat_small_image\' LIMIT 1');
		$database->execute();

		$database->setQuery('UPDATE `#__mt_config` SET `default` = \'/media/com_mtree/images/cats/o/\', `value` = \'/media/com_mtree/images/cats/o/\' WHERE varname = \'relative_path_to_cat_original_image\' LIMIT 1');
		$database->execute();

		$database->setQuery('UPDATE `#__mt_config` SET `default` = \'/media/com_mtree/images/listings/s/\', `value` = \'/media/com_mtree/images/listings/s/\' WHERE varname = \'relative_path_to_listing_small_image\' LIMIT 1');
		$database->execute();

		$database->setQuery('UPDATE `#__mt_config` SET `default` = \'/media/com_mtree/images/listings/m/\', `value` = \'/media/com_mtree/images/listings/m/\' WHERE varname = \'relative_path_to_listing_medium_image\' LIMIT 1');
		$database->execute();

		$database->setQuery('UPDATE `#__mt_config` SET `default` = \'/media/com_mtree/images/listings/o/\', `value` = \'/media/com_mtree/images/listings/o/\' WHERE varname = \'relative_path_to_listing_original_image\' LIMIT 1');
		$database->execute();
