<?php
/**
 * @version	$Id: customfields.mtree.html.php 2054 2013-09-11 09:56:49Z cy $
 * @package	Mosets Tree
...
class HTML_mtcustomfields {
	...
	function editcf( $row, $custom_cf_types, $lists, $isDisabled, $cats, $fields_map_cats, $form, $option ) {
